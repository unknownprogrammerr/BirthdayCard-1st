...
// --- Message Loop ---
const messages = [
  "آرزو می‌کنم هر روزت پر از عشق و شادی باشه 🎈",
  " فوق‌العاده‌ای و لیاقت تموم خوشبختی‌ها رو داری 🥳",
  "امیدوارم همه‌ی آرزوهات به حقیقت بپیوندن 🌟",
  "به خنده‌ها و خاطره‌های فراموش‌نشدنی 🧁",
  "آرزوی کلی بغل، لبخند و کلی کیک  🎂",
  "امیدوارم امسال برات پر از نور و عشق باشه 💖",
  "تو یه هدیه‌ای برای هر کسی هستی که می‌شناستت 🎁"
];
